...
//$(window).on('load',function() {
    ...
    $.getJSON(url, function(data, textstatus) {
          $.each(data, function(i, entry) {
              array_aux.push(entry.avg_monthly_gross_rent)
             
             var loc=entry.location_street_a ;
            
               
                     $.ajax({
                     url:'https://maps.googleapis.com/maps/api/geocode/json?address='+loc+',NY&key=AIzaSyDtmLFzN5Uinsti8VwuxhmhKADKs1fCiao',
                     dataType: 'json'
                  }).done(function(obj){
                    ...
                    var marker = new google.maps.Marker({
                                      ...
                                      position: new google.maps.LatLng(obj.results[0].geometry.location.lat, 
                     ...
                     if(parseFloat(obj.results[0].geometry.location.lat) ==40.7330038 && parseFloat(obj.results[0].geometry.location.lng)==-73.9935848  )       {
                         
                         marker.setIcon('https://cdn3.iconfinder.com/data/icons/dollar-business/512/home_rent-64.png');
                     }
                       if(parseFloat(obj.results[0].geometry.location.lat) ==40.7287239 && parseFloat(obj.results[0].geometry.location.lng)==-73.9861761  )       {
                         
                         marker.setIcon('https://cdn3.iconfinder.com/data/icons/dollar-business/512/home_rent-64.png');
                     }
                       if(parseFloat(obj.results[0].geometry.location.lat) ==40.7236185 && parseFloat(obj.results[0].geometry.location.lng)==-73.9892192  )       {
                         
                         marker.setIcon('https://cdn3.iconfinder.com/data/icons/dollar-business/512/home_rent-64.png');
                     }  if(parseFloat(obj.results[0].geometry.location.lat) ==40.7994169 && parseFloat(obj.results[0].geometry.location.lng)==-73.9374899  )       {
                         
                         marker.setIcon('https://cdn4.iconfinder.com/data/icons/banking-flat-curve-bg/614/958_-_Savings-128.png');
                     }       
